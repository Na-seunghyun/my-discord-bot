...
def get_avg_damage_feedback(avg):
    if avg < 100:
        return random.choice([
            "📉 평균 데미지가 낮아요. 초반 교전에서 조금 더 자신감을 가져보세요.",
            "😢 공격력이 아쉽습니다. 정확한 사격 연습을 추천드려요.",
            "🔫 교전에서 딜량을 더 늘리기 위해 위치 선정에 신경 써보세요.",
            "⚠️ 피해량이 적으면 상대를 제압하기 어려워요. 공격 타이밍을 잡아보세요.",
            "🎯 더 많은 데미지를 입히려면 사격 연습과 무기 숙련도를 높여야 합니다."
        ])
    elif avg < 200:
        return random.choice([
            "🟠 데미지가 약간 낮은 편입니다. 교전 빈도를 늘려보세요.",
            "⚡ 초보 단계를 벗어나고 있어요. 더 적극적인 플레이가 필요합니다.",
            "📈 점차 나아지고 있습니다. 조금 더 공격적으로 싸워보세요.",
            "👍 딜량이 평균 이상으로 올라가고 있습니다. 좋은 흐름이에요!",
            "🧠 위치 선정과 사격 타이밍이 점점 개선되고 있습니다."
        ])
    elif avg < 300:
        return random.choice([
            "🟡 준수한 평균 데미지입니다. 전투 감각이 좋아지고 있네요.",
            "🎖 좋은 딜량으로 전투에서 영향력이 커지고 있습니다.",
            "🚀 꾸준한 공격력으로 팀 플레이에 크게 기여하고 있어요.",
            "🔥 교전에서 안정적인 딜량을 보여주고 있습니다.",
            "💪 전장 주도권을 잡는 데 한 걸음 더 가까워지고 있습니다."
        ])
    elif avg < 500:
        return random.choice([
            "🟢 매우 좋은 데미지입니다! 적에게 큰 위협이 되고 있네요.",
            "🏆 뛰어난 딜량으로 전투를 지배하고 있습니다.",
            "💥 공격적인 플레이가 빛을 발하고 있습니다.",
            "🎯 무기 숙련도와 사격 실력이 탁월해 보입니다.",
            "🔥 팀 내 핵심 딜러로서 활약 중입니다."
        ])
    else:
        return random.choice([
            "💥 압도적인 데미지! 프로 선수 못지않은 수준입니다.",
            "🔥 전투를 지배하는 엄청난 피해량이에요.",
            "⚡ 모든 교전에서 강력한 존재감을 보여줍니다.",
            "🏅 최고의 딜러로 팀 승리에 큰 역할을 하고 있어요.",
            "🎉 완벽한 공격력으로 상대를 압도하고 있습니다."
        ])

def get_kd_feedback(kd):
    if kd < 0.3:
        return random.choice([
            "😢 K/D가 낮아 생존에 어려움이 있습니다. 신중한 플레이를 권장해요.",
            "⚠️ 교전 후 마무리가 약해요. 차분히 싸움을 끝내는 연습을 해보세요.",
            "🔻 전투 능력이 부족해 보입니다. 은신과 회피에 집중하세요.",
            "😟 킬 확정 능력을 키우면 전적이 더 좋아질 거예요.",
            "🚶 신중하게 움직이며 싸움을 피하는 것도 전략입니다."
        ])
    elif kd < 0.6:
        return random.choice([
            "⚠️ K/D가 약간 낮은 편입니다. 마무리 능력을 좀 더 키워보세요.",
            "😶 킬을 따내는 힘이 조금 부족해요. 교전 후 확정력을 높이세요.",
            "🎯 싸움을 끝내는 능력을 연습하면 도움이 됩니다.",
            "🛡 생존 위주 플레이에서 벗어나 적극적으로 싸워보세요.",
            "💡 집중력을 높여 교전 마무리에 신경 써보세요."
        ])
    elif kd < 1.0:
        return random.choice([
            "👍 안정적인 K/D입니다. 점차 공격적으로 변해보세요.",
            "🟢 괜찮은 전투 실력입니다. 킬 기회를 더 노려보세요.",
            "✅ 전장에서 점점 자신감을 얻고 있어요!",
            "🎯 마무리 능력이 좋아지고 있습니다. 계속 노력하세요.",
            "🚀 좋은 K/D로 팀에 도움이 되고 있습니다."
        ])
    elif kd < 2.0:
        return random.choice([
            "💪 훌륭한 K/D입니다! 전투 감각이 매우 뛰어나네요.",
            "🔥 전투 중심에서 팀을 이끄는 플레이어입니다.",
            "👏 안정적인 킬 능력으로 팀에 큰 힘이 되고 있어요.",
            "⭐ 전장에서는 언제나 믿음직한 존재입니다.",
            "🚀 높은 K/D를 유지하며 적에게 큰 위협이 되고 있어요."
        ])
    else:
        return random.choice([
            "💥 압도적인 K/D! 전장의 에이스입니다.",
            "🔥 공격적이고 효율적인 플레이로 팀을 캐리하고 있어요.",
            "🏆 최고의 전투력을 가진 선수 중 하나입니다.",
            "⚡ 적들을 제압하는 놀라운 능력을 보여주고 있습니다.",
            "🎖 전투의 주인공으로 팀을 승리로 이끌고 있습니다."
        ])

def get_winrate_feedback(win_rate):
    if win_rate == 0:
        return random.choice([
            "😓 아직 승리가 없네요. 생존과 전략에 집중해 보세요.",
            "📉 승리 경험이 없으면 끝까지 버티는 연습이 필요합니다.",
            "🌀 후반 라운드 집중력이 중요합니다. 인내심을 가져보세요.",
            "😟 위치 선정과 회피가 부족해 보입니다. 전략을 고민하세요.",
            "⚠️ 승리를 위해 좀 더 신중한 플레이가 필요합니다."
        ])
    elif win_rate < 5:
        return random.choice([
            "🛠 승률이 낮은 편입니다. 안전한 플레이를 시도해보세요.",
            "🔍 진입과 회피를 신중히 하여 생존 시간을 늘려보세요.",
            "🚶 조심스럽게 움직이며 팀과 협력하는 것을 추천합니다.",
            "🛡 생존 위주 운영이 승률 상승에 도움이 됩니다.",
            "⚠️ 승률 향상을 위해 교전 빈도를 조절해보세요."
        ])
    elif win_rate < 10:
        return random.choice([
            "📈 승률이 점차 좋아지고 있습니다. 팀워크를 강화하세요.",
            "🤝 협력과 포지셔닝이 승률 향상의 핵심입니다.",
            "📊 꾸준한 성장세입니다. 더 좋은 결과가 기대됩니다.",
            "🎯 팀 플레이에 더욱 집중하면 더 나아질 거예요.",
            "👍 승률 향상을 위한 전략 수정이 효과를 발휘하고 있습니다."
        ])
    elif win_rate < 20:
        return random.choice([
            "🏅 좋은 승률입니다! 전략과 전투가 잘 조화를 이루고 있어요.",
            "😎 안정적인 운영으로 팀에 큰 도움이 되고 있습니다.",
            "🛡 전투와 생존 모두 뛰어난 실력을 보여주고 있어요.",
            "🔥 팀 플레이와 개인 실력이 잘 어우러지고 있습니다.",
            "💪 꾸준한 성과로 팀 내 신뢰를 받고 있습니다."
        ])
    else:
        return random.choice([
            "🥇 매우 높은 승률! 거의 완성형 플레이어입니다.",
            "👑 뛰어난 전술과 팀워크로 꾸준히 승리하고 있어요.",
            "🏆 도전자들을 압도하는 뛰어난 경기력을 보여줍니다.",
            "⚡ 승률 상위권에 들어가는 놀라운 성과입니다.",
            "🎉 팀의 중심이 되어 승리를 이끌고 있습니다."
        ])
